...
import { fork as fork2, call as call3, take as take3, put as put2, all, cancelled as cancelled3 } from "@redux-saga/core/effects";

// src/redux/features/session/sessionSaga.ts
import { eventChannel as eventChannel2 } from "@redux-saga/core";
import { call as call2, put, take, fork, cancelled } from "@redux-saga/core/effects";
...
function* initSessionSaga({
  ...
  const executeActionTask = yield fork2(executeActionWatcher, session);
  session.connect();
    ...
    while (true) {
      ...
      switch (action.type) {
        ...
        case sessionDisconnectedAction.type: {
          yield put2(options.pubSubChannel, sessionDisconnectedAction());
          yield put2(destroyAction());
          break;
        }
      }
    }
